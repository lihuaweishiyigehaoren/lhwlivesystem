...
/*
函数功能：构造函数
参数：ClientSocket *cs, QTcpSocket *socket, QString curRoom,User user, QWidget *parent
返回值：无
*/
    ...
    ui(new Ui::ChatRoom)
{
    ...
    QObject::connect (cs, SIGNAL(sigChatName(User)),
                      this, SLOT(onsigChatName(User)));
    QObject::connect (cs, SIGNAL(sigChatList(User)),
                      this, SLOT(onsigChatList(User)));
    QObject::connect (cs, SIGNAL(sigChatText(User)),
                      this, SLOT(onsigChatText(User)));
    QObject::connect(cs, SIGNAL(sigMasterExit(User)),
                     this, SLOT(onsigMasterExit(User)));
    QObject::connect (cs, SIGNAL(sigVideo(User)),
                      this, SLOT(onsigVideo(User)));
    QObject::connect (cs, SIGNAL(sigunVideo(User)),
                      this, SLOT(onsigunVideo(User)));
    QObject::connect (cs, SIGNAL(sigBs(User)),
                      this, SLOT(onsigBs(User)));
...
返回值：无
*/
void ChatRoom::onsigChatName (User user)
{
...
返回值：无
*/
void ChatRoom::onsigChatList (User user)
{
...
返回值：无
*/
void ChatRoom::onsigChatText(User user)
{
...
返回值：无
*/
void ChatRoom::onsigMasterExit(User user)
{
...
返回值：无
*/
void ChatRoom::onsigVideo (User user)
{
    if(user.flag != MASTER){
...
返回值：无
*/
void ChatRoom::onsigunVideo (User user)
{
    if(user.flag != MASTER){
...
返回值：无
*/
void ChatRoom::onsigBs (User user)
{
