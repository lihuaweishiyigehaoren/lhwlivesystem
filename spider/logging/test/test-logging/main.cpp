...
int32_t main()
{
    ...
    LOG(LOG_INFO) << "hello " << 123 << std::endl
                  << "lkdasjflajl";
    LOG(LOG_INFO) << "hello " << 345 << std::endl
                  << "lkdasjflajl";
    LOG(LOG_INFO) << "hello " << 456 << std::endl
                  << "lkdasjflajl";
    LOG(LOG_INFO) << "hello " << 678 << std::endl
                  << "lkdasjflajl";
    LOG(LOG_INFO) << "hello " << 890 << std::endl
                  << "lkdasjflajl";
    LOG(LOG_INFO) << "hello " << 012 << std::endl
                  << "lkdasjflajl";
